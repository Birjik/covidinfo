...
Legend.generateLegendHTML = function (g, x, sel_points, oneEmWidth, row) {
  ...
  if(currentState == "Confirmed")
    return data.series[0].y + " <span style = 'color:#4285F4; font-weight:600;'>new cases</span> at " + convert(data.xHTML);
  return data.series[0].y + " <span style = 'color:#4285F4; font-weight:600;'>active cases</span> at " + convert(data.xHTML);
